...
import jp.cyber_wars.domain.dto.game.defence.FetchRevisionPathResponse;
import jp.cyber_wars.domain.dto.game.defence.SendCodeRequest;
import jp.cyber_wars.domain.dto.game.defence.SendCodeResponse;
...
public class GameDefenceService {
  ...
  public SendCodeResponse sendCode(
    ...
    final String revisionDirectoryPath =
        Constant.PHP_DIRECTORY_PATH + "game/" + roomId + "/revision/";
