...
import jp.cyber_wars.application.Constant;
import jp.cyber_wars.application.utility.ArrayToStringConverter;
import jp.cyber_wars.application.utility.CodeReplacer;
import jp.cyber_wars.application.utility.TableUtility;
import jp.cyber_wars.application.utility.UserIdFetcher;
import jp.cyber_wars.domain.dto.game.EndRequest;
import jp.cyber_wars.domain.dto.game.EndResponse;
import jp.cyber_wars.domain.dto.game.FetchExplanationResponse;
import jp.cyber_wars.domain.dto.game.FetchScoresResponse;
import jp.cyber_wars.domain.dto.game.FetchStartTimeResponse;
...
public class GameService {
  ...
  public void start(final HttpServletRequest httpServletRequest) {
    ...
    try {
      final String challengeDirectoryPath =
          Constant.PHP_DIRECTORY_PATH + "challenge/" + challengeId;
      ...
      final File challengeVendorFile = new File(Constant.PHP_DIRECTORY_PATH + "vendor");
      final String gameDirectoryPath = Constant.PHP_DIRECTORY_PATH + "game/" + roomId;
  ...
  public EndResponse end(
    ...
    try {
      FileUtils.forceDelete(new File(Constant.PHP_DIRECTORY_PATH + "game/" + roomId));
    } catch (final Exception exception) {
      exception.printStackTrace();
